defmodule DailyGoalsWeb.CoreComponents do
  ...
  def simple_form(assigns) do
    ...
    <.form :let={f} for={@for} as={@as} {@rest}>
      <div class="grid gap-3 items-center grid-cols-6">
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(DailyGoalsWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(DailyGoalsWeb.Gettext, "errors", msg, opts)
    # end
